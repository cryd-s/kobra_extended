...
1. Download the DWIN_SET ([created with the Dgus-Tool](https://github.com/cryd-s/kobra_extended/blob/main/dgus_project/DWIN_SET.zip)) unzip it and copy to a correctly formatted microSD card.
